...
NTSTATUS driverMain(PDRIVER_OBJECT driverObject, PUNICODE_STRING registryPath) {
    ...
    RtlInitUnicodeString(&deviceName, L"\\Device\\broDriver");
    ...
    RtlInitUnicodeString(&symbolicLink, L"\\DosDevices\\broDriver");
...
NTSTATUS DriverEntry() {
    ...
    RtlInitUnicodeString(&driverName, L"\\Driver\\broDriver");
